...
/**
 * 注意：
 * topic=org.apache.kafka.common.internals.Topic#TRANSACTION_STATE_TOPIC_NAME
 * kafka.server.KafkaApis#getCoordinator(kafka.network.RequestChannel.Request, byte, java.lang.String)
 */
